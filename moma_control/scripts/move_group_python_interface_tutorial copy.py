...
class MoveGroupPythonInterfaceTutorial(object):
    ...
    def go_to_joint_state(self):
        ...
        '''
        '''
        #########################can get  start the obj info wrist camera######################
        joint_goal[0] = 0
        joint_goal[1] = 0
    ...
    def plan_cartesian_path(self, scale=1):
        ...
        (plan, fraction) = move_group.compute_cartesian_path(
            waypoints, 0.0002, 0.0  # waypoints to follow  # eef_step
        )  # jump_threshold

        # Note: We are just planning, not asking move_group to actually move the robot yet:
        # Assuming 'plan' is the computed trajectory
        for point in plan.joint_trajectory.points:
            print(point.velocities)
            #for i in range(len(point.velocities)):
                #print(point.velocities[i])
                #point.velocities[i] *= 0.1  # Scale velocities as needed
        #scaled_plan = moveit_msgs.msg.RobotTrajectory()

        ## Copy header and joint names
        #scaled_plan.joint_trajectory.header = plan.joint_trajectory.header
        #scaled_plan.joint_trajectory.joint_names = plan.joint_trajectory.joint_names

        ## Scale velocities
        #scaling_factor = 0.1  # Adjust as needed
        #for point in plan.joint_trajectory.points:
            #scaled_point = moveit_msgs.JointTrajectoryPoint()
            #scaled_point.positions = point.positions
            #scaled_point.velocities = [v * scaling_factor for v in point.velocities]
            #scaled_point.time_from_start = point.time_from_start
            #scaled_plan.joint_trajectory.points.append(scaled_point)
...
def main():
    try:
        ...
        # input("============ Press `Enter` to execute a movement using a pose goal ...")
        # tutorial.go_to_pose_goal(x=0.5,y=0.0,z=0.4)
        # input("============ Press `Enter` to execute a movement using a pose goal ...")
        # tutorial.go_to_pose_goal(x=0.5,y=-0.25,z=0.20)
        
        # input("============ Press `Enter` to execute a movement using a pose goal ...")
        # tutorial.go_to_pose_goal(x=0.5,y=-0.25,z=0.145)
        # input("============ Press `Enter` to return back to rotate wrist...")
        # tutorial.rot_90_wrist()
        ...
        '''
        input("============ Press `Enter` to return back to go down ...")
        tutorial.go_down()
        input("============ Press `Enter` to return back to go down ...")
        tutorial.go_down()
        '''
        ...
        #tutorial.rot_90_wrist()
        #tutorial.push(ori=2)
        #input("============ Press `Enter` to return back to previous pose ...")
        #tutorial.go_to_joint_state()
        #input(
